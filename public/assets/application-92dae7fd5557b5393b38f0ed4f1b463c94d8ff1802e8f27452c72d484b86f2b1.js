...
(function() {
  App.rendezvous = App.cable.subscriptions.create({
    ...
    join_game: function(users_game_name) {
      return this.perform('join_game', {
        users_game_name: users_game_name
      });
    },
    unjoin_game: function() {
      return this.perform('unjoin_game');
    },
    start_game: function() {
      return this.perform('start_game');
    },
    received: function(data) {
      if (data.partial !== void 0) {
        return $("[data-id=currently-joined]").replaceWith(data.partial);
...
(function(){
  ...
  var link = document.getElementById('photoinfo').getAttribute('action')

  document.getElementById('photoinfo').onchange = function(){
  ...
  var files = document.getElementById('photoinfo').files;

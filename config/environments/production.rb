Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "telestrations_#{Rails.env}"
  ...
  config.web_socket_server_url = Rails.application.credentials.dig(:production, :web_socket_server_url) 
end

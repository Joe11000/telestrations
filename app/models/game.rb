...
# midgame public methods
  ...
  def set_up_next_players_turn current_card
    ...
    if next_player.id == gu.user_id
      ...
      #     return # [ { game_over: false, attention_users: current_card.uploader_id, set_complete: true } ]
      # end
    else
      ...
      #   next_player_message_params.merge!({ prev_card: {id: current_card.id, description_text: current_card.description_text} })
      # else
      #   next_player_message_params.merge!({ prev_card: {id: current_card.id, drawing_url: current_card.drawing.url} })
      # end
    end
     ...
     #    if current_card.description?
     #      current_player_message_params.merge!({ prev_card: {id: existing_placeholder_for_uploading_user.parent_current_card.id, description_text: existing_placeholder_for_uploading_user.parent_current_card.description_text} })
     #    else
     #      current_player_message_params.merge!({ prev_card: {id: existing_placeholder_for_uploading_user.parent_current_card.id, drawing_url: existing_placeholder_for_uploading_user.parent_current_card.drawing.url} })
     #    end
     #  end
